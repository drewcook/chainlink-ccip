...
contract TTTDemo is CCIPReceiver, OwnerIsCreator {
    ...
    bytes32 constant WC_0 =
        keccak256(abi.encodePacked([1, 1, 1, 0, 0, 0, 0, 0, 0]));
    bytes32 constant WC_1 =
        keccak256(abi.encodePacked([1, 0, 0, 0, 1, 0, 0, 0, 1]));
    bytes32 constant WC_2 =
        keccak256(abi.encodePacked([1, 0, 0, 1, 0, 0, 1, 0, 0]));
    bytes32 constant WC_3 =
        keccak256(abi.encodePacked([0, 1, 0, 0, 1, 0, 0, 1, 0]));
    bytes32 constant WC_4 =
        keccak256(abi.encodePacked([0, 0, 1, 0, 0, 1, 0, 0, 1]));
    bytes32 constant WC_5 =
        keccak256(abi.encodePacked([0, 0, 1, 0, 1, 0, 1, 0, 0]));
    bytes32 constant WC_6 =
        keccak256(abi.encodePacked([0, 0, 0, 1, 1, 1, 0, 0, 0]));
    bytes32 constant WC_7 =
        keccak256(abi.encodePacked([0, 0, 0, 0, 0, 0, 1, 1, 1]));
            ...
            if (
                ...
                if (
                    checkWin(
                        keccak256(
                            abi.encodePacked(
                                gameSessions[sessionId].player1Status
                            )
                        )
                    )
                ) {
            ...
            if (
                ...
                if (
                    checkWin(
                        keccak256(
                            abi.encodePacked(
                                gameSessions[sessionId].player2Status
                            )
                        )
                    )
                ) {
