...
const ETHEREUM_SEPOLIA_RPC_URL = process.env.ALCHEMY_SEPOLIA_RPC_URL;
const POLYGON_MUMBAI_RPC_URL = process.env.INFURA_POLYGON_MUMBAI_RPC_URL;
...
const AVALANCHE_FUJI_RPC_URL = process.env.INFURA_AVALANCHE_FUJI_RPC_URL;
